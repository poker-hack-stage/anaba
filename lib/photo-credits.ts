...
export const PHOTO_CREDITS: PhotoCredit[] = [
  ...
  {
    kind: "photo",
    path: "/images/spots/miyoshi-01.jpg",
    subject: "祖谷のかずら橋",
    title: "Kazura-bashi, Iya Valley 02.jpg",
    author: "Hiroaki Kaneko",
    license: "CC BY-SA 2.0",
    licenseUrl: BY_SA_2,
    sourceUrl: `${COMMONS}Kazura-bashi,_Iya_Valley_02.jpg`,
    sourceName: "Wikimedia Commons",
  },
  {
    kind: "photo",
    path: "/images/spots/miyoshi-02.jpg",
    subject: "大歩危峡観光遊覧船",
    title: "大步危峽遊覽船 Oboke Gorge Tour Boat - panoramio.jpg",
    author: "lienyuan lee",
    license: "CC BY 3.0",
    licenseUrl: BY_3,
    sourceUrl: `${COMMONS}%E5%A4%A7%E6%AD%A5%E5%8D%B1%E5%B3%BD%E9%81%8A%E8%A6%BD%E8%88%B9_Oboke_Gorge_Tour_Boat_-_panoramio.jpg`,
    sourceName: "Wikimedia Commons",
  },
  {
    kind: "photo",
    path: "/images/spots/miyoshi-03.jpg",
    subject: "落合集落",
    title: "A mountainside village, built on terraces (6551524129).jpg",
    author: "KimonBerlin",
    license: "CC BY-SA 2.0",
    licenseUrl: BY_SA_2,
    sourceUrl: `${COMMONS}A_mountainside_village,_built_on_terraces_(6551524129).jpg`,
    sourceName: "Wikimedia Commons",
  },
  {
    kind: "photo",
    path: "/images/spots/miyoshi-04.jpg",
    subject: "阿波池田うだつの家 たばこ資料館",
    title: "Awa-Ikeda Udatsu House omoya ac (1).jpg",
    author: "Asturio Cantabrio",
    license: "CC BY-SA 4.0",
    licenseUrl: BY_SA_4,
    sourceUrl: `${COMMONS}Awa-Ikeda_Udatsu_House_omoya_ac_(1).jpg`,
    sourceName: "Wikimedia Commons",
  },
];
