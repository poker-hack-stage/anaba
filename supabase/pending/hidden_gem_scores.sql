...
-- 池田町
update public.spots set hidden_gem_score = 5 where id = '20000000-0000-4000-8000-000000000301'; -- 池田八幡神社
...
update public.spots set hidden_gem_score = 5 where id = '20000000-0000-4000-8000-000000000307'; -- HOP FROG CAFE
update public.spots set hidden_gem_score = 5 where id = '20000000-0000-4000-8000-000000000308'; -- 発酵と暮らし おはこ
-- 安曇野市
...
update public.spots set hidden_gem_score = 5 where id = '20000000-0000-4000-8000-000000000404'; -- 貞享義民記念館
